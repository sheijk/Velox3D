...
uniform vec4 msl_Generator_brick_1_brick_color;
uniform vec4 msl_Generator_brick_1_mortar_color;
uniform float msl_Generator_brick_1_brick_width;
uniform float msl_Generator_brick_1_brick_height;
uniform float msl_Generator_brick_1_brick_horizontal_spacing;
uniform float msl_Generator_brick_1_brick_vertical_spacing;
...
void Math_color_multiply_1_Component_falloff_main(float msl_amount,State state,out vec4 msl_result)
{
	{
...
void Math_color_multiply_1_Generator_brick_main(vec4 msl_brick_color,vec4 msl_mortar_color,float msl_brick_width,float msl_brick_height,float msl_brick_horizontal_spacing,float msl_brick_vertical_spacing,State state,out vec4 msl_result)
{
	{
		msl_result = vec4(0., 0., 0., 0.);
		vec2 msl_0 = ((state.tex_coord)[2]).xy;
		vec2 msl_1 = vec2(msl_brick_width, msl_brick_height);
		vec2 msl_pos = msl_0 / msl_1;
		if (fract(((msl_pos.y * 0.5))) > 0.5)
		{
			msl_pos.x += 0.5;
		}
		msl_pos = fract(msl_pos);
		vec2 msl_useBrick = step(msl_pos,vec2(msl_brick_horizontal_spacing, msl_brick_vertical_spacing));
		float msl_2 = msl_useBrick.x * msl_useBrick.y;
		vec4 msl_bc = mix(msl_mortar_color,msl_brick_color,vec4(msl_2, msl_2, msl_2, msl_2));
		msl_result = msl_bc;
		msl_result.a = 1.0;
	}
}
...
void Math_color_multiply_1_Math_color_multiply_main(vec4 msl_left,vec4 msl_right,State state,out vec4 msl_result)
{
	{
...
//
vec4 Math_color_multiply_1_eval(State state)
{
	vec4 msl_result;
	vec4 msl_Component_falloff_1_result = vec4(0.000000, 0.000000, 0.000000, 0.000000);
	Math_color_multiply_1_Component_falloff_main(msl_Component_falloff_1_amount,(state),msl_Component_falloff_1_result);
	vec4 msl_Generator_brick_1_result = vec4(0.000000, 0.000000, 0.000000, 0.000000);
	Math_color_multiply_1_Generator_brick_main(msl_Generator_brick_1_brick_color,msl_Generator_brick_1_mortar_color,msl_Generator_brick_1_brick_width,msl_Generator_brick_1_brick_height,msl_Generator_brick_1_brick_horizontal_spacing,msl_Generator_brick_1_brick_vertical_spacing,(state),msl_Generator_brick_1_result);
	Math_color_multiply_1_Math_color_multiply_main(msl_Component_falloff_1_result,msl_Generator_brick_1_result,(state),msl_result);
	return msl_result;
}
...
void main()
{
	...
	state.tex_coord[0] = tex_coord0;
	state.tex_coord[1] = tex_coord1;
	state.tex_coord[2] = tex_coord2;
	state.tex_coord[3] = tex_coord3;
	state.direction = normalize(state.position);
	gl_FragColor = Math_color_multiply_1_eval(state);
}
