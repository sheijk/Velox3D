#ifndef V3D_VSPACE_2004_11_07_H
#define V3D_VSPACE_2004_11_07_H
//-----------------------------------------------------------------------------
...
public:
	 ...
	 */
    void AddSubSpace(VSpace* in_Space);
	 ...
	 */
    void SetWorld(VWorld* in_PhysicWorld);
	
	/**
	 * Set a joint group for this space collision can be calculated
	 */
	void SetJointGroup(VJointGroup* in_JointGroup);
...
private:
	...
	typedef std::map<dSpaceID, VSpace*> SpaceList;
