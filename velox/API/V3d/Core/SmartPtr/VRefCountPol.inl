 ...
 */
template<class StoragePolicy> 
typename VRefCountPol<StoragePolicy>::Pointer VRefCountPol<StoragePolicy>
	::Get() const
{
...
template<class StoragePolicy> 
void VRefCountPol<StoragePolicy>
	::CreateSharedStorage(Pointer in_Subject)
{
	m_pSharedStorage = SharedStorage::CreateNew(in_Subject);
}

template<class StoragePolicy>
vbool VRefCountPol<StoragePolicy>
	::IsEqual(const VRefCountPol<StoragePolicy>& in_Other) const
{
	return Get() == in_Other.Get();
}
