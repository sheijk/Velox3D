...
*/
template<class StoragePolicy> 
typename VExclusiveOwnerPol<StoragePolicy>::Pointer
...
template<class StoragePolicy>
bool VExclusiveOwnerPol<StoragePolicy> 
	::IsEqual(const VExclusiveOwnerPol& in_Other) const
{
	return StoragePolicy::IsEqual(in_Other);
}
