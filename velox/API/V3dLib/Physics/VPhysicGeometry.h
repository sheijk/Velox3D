#ifndef V3D_VPHYSICGEOMETRY_2004_11_19_H
#define V3D_VPHYSICGEOMETRY_2004_11_19_H
//-----------------------------------------------------------------------------
...
protected:
	...
	VPhysicGeometry();
	virtual ~VPhysicGeometry();

	VPhysicGeometry(const VPhysicGeometry&);
	VPhysicGeometry& operator=(const VPhysicGeometry&);
...
//-----------------------------------------------------------------------------
#endif // V3D_VPHYSICGEOMETRY_2004_11_19_H
