#ifndef V3D_VPHYSICJOINT_2004_11_07_H
#define V3D_VPHYSICJOINT_2004_11_07_H
//-----------------------------------------------------------------------------
...
public:
	 ...
	 */
	void AddJointGroup(VPhysicJointGroup* in_pJointGroup);
...
private:
	...
	VPhysicJoint(const VPhysicJoint&);
	VPhysicJoint& operator=(const VPhysicJoint&);
...
protected:
	 ...
	 */
	void AddWorld(VPhysicWorld* in_pPhysicWorld);

	dJointID m_JointID;
	VPhysicWorld* m_pPhysicWorld;
	VPhysicJointGroup* m_pJointGroup;
...
//-----------------------------------------------------------------------------
#endif // V3D_VPHYSICJOINT_2004_11_07_H
