...
/**
 * Handles keys and menu/toolbar commands to play/pause the scene
 * 
 * @author sheijk
 * @see de.velox.editor.scene.ActivateInputAction
 */
public class RunSceneAction implements IEditorActionDelegate, IHandler {
