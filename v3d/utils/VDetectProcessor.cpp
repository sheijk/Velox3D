#include <Utils/VDetectProcessor.h>
...
void VDetectProcessor::GetStandardProcessorExtensions()
{
	...
	m_CPUInfo._Ext.APIC_AdvancedProgrammableInterruptController	= CheckBit(edxreg, 9);
	...
	m_CPUInfo._Ext.CMOV_ConditionalMoveAndCompareInstructions	= CheckBit(edxreg, 15);
	...
	m_CPUInfo._Ext.FXSR_FastStreamingSIMD_ExtensionsSaveRestore	= CheckBit(edxreg, 24);
...
vint64 VDetectProcessor::GetCPUFrequency(vuint uiMeasureMSecs)
{
	...
	m_iFrequency = (((vfloat64)(vlong) dif) / (((vfloat64)(vlong) timedif) / (vlong)freq));
...
vbool VDetectProcessor::AnalyzeIntelProcessor()
{
	...
	switch (m_CPUInfo.uiBrandID)
	{
		...
		case 3:			// Brand id = 3:  Model dependent
			if (m_CPUInfo.uiModel == 6)	// If the cpu model is Celeron (well, I'm NOT SURE!!!)
		...
		case 4:			// i486 (80486) processor family
			switch (m_CPUInfo.uiModel)
			{
				...
				case 3:			// Model = 3:  i486 DX2 (with i487 numeric coprocessor) processor model
					...
					strcat(m_cCPUName, "Intel i486 DX2 with i487 numeric coprocessor");
					break;
				...
				case 7:			// Model = 7:  i486 write-back enhanced DX2 processor model
					strcpy(m_CPUInfo.strModel, "Intel i486 write-back enhanced DX2");
				...
				case 9:			// Model = 9:  i486 write-back enhanced DX4 processor model
					strcpy(m_CPUInfo.strModel, "Intel i486 write-back enhanced DX4");
					strcat(m_cCPUName, "Intel i486 DX4");
					break;
				default:		// ...
		...
		case 5:			// Pentium (80586) processor family
			switch (m_CPUInfo.uiModel)
			{
				...
				case 3:			// Model = 3:  Pentium overdrive for 486 systems processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium for 486 system (P24T Overdrive)");
					strcat(m_cCPUName, "Intel Pentium for 486 (P24T overdrive core)");
					break;
				...
				case 8:			// Model = 8:  Pentium MMX (0.25 µm) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium MMX (P55C), 0.25 µm");
					strcat(m_cCPUName, "Intel Pentium MMX (P55C core), 0.25 µm");
					break;
				default:		// ...
		...
		case 6:			// Pentium Pro (80686) processor family
			switch (m_CPUInfo.uiModel)
			{
				case 0:			// Model = 0:  Pentium Pro (P6 A-Step) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium Pro (P6 A-Step)");
				...
				case 3:			// Model = 3:  Pentium II (66 MHz FSB, I think) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium II Model 3, 0.28 µm");
					strcat(m_cCPUName, "Intel Pentium II (Model 3 core, 0.28 µm process)");
					break;
				case 5:			// Model = 5:  Pentium II/Xeon/Celeron (0.25 µm) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium II Model 5/Xeon/Celeron, 0.25 µm");
					strcat(m_cCPUName, "Intel Pentium II/Xeon/Celeron (Model 5 core, 0.25 µm process)");
					break;
				case 6:			// Model = 6:  Pentium II with internal L2 cache
					strcpy(m_CPUInfo.strModel, "Intel Pentium II - internal L2 cache");
					strcat(m_cCPUName, "Intel Pentium II with internal L2 cache");
					break;
				case 7:			// Model = 7:  Pentium III/Xeon (extern L2 cache) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium III/Pentium III Xeon - external L2 cache, 0.25 µm");
					strcat(m_cCPUName, "Intel Pentium III/Pentium III Xeon (0.25 µm process) with external L2 cache");
					break;
				case 8:			// Model = 8:  Pentium III/Xeon/Celeron (256 KB on-die L2 cache) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium III/Celeron/Pentium III Xeon - internal L2 cache, 0.18 µm");
					// We want to know it exactly:
					switch (m_CPUInfo.uiBrandID)
					{
						case 1:			// Model = 8, Brand id = 1:  Celeron (on-die L2 cache) processor model
							strcat(m_cCPUName, "Intel Celeron (0.18 µm process) with internal L2 cache");
							break;
                        case 2:			// Model = 8, Brand id = 2:  Pentium III (on-die L2 cache) processor model (my current cpu :-))
							strcat(m_cCPUName, "Intel Pentium III (0.18 µm process) with internal L2 cache");
							break;
						case 3:			// Model = 8, Brand id = 3:  Pentium III Xeon (on-die L2 cache) processor model
                            strcat(m_cCPUName, "Intel Pentium III Xeon (0.18 µm process) with internal L2 cache");
							break;
						default:		// ...²
							strcat(m_cCPUName, "Intel Pentium III core (unknown model, 0.18 µm process) with internal L2 cache");
							break;
					}
					break;
				...
				case 0xB:		// Model = 0xB: Pentium III/Xeon/Celeron (Tualatin core, on-die cache) processor model
					strcpy(m_CPUInfo.strModel, "Intel Pentium III/Celeron/Pentium III Xeon - internal L2 cache, 0.13 µm");
					// Omniscient: ;-)
					switch (m_CPUInfo.uiBrandID)
					{
						case 3:			// Model = 0xB, Brand id = 3:  Celeron (Tualatin core) processor model
							strcat(m_cCPUName, "Intel Celeron (Tualatin core, 0.13 µm process) with internal L2 cache");
							break;
                        case 4:			// Model = 0xB, Brand id = 4:  Pentium III (Tualatin core) processor model
							strcat(m_cCPUName, "Intel Pentium III (Tualatin core, 0.13 µm process) with internal L2 cache");
							break;
						case 7:			// Model = 0xB, Brand id = 7:  Celeron mobile (Tualatin core) processor model
                            strcat(m_cCPUName, "Intel Celeron mobile (Tualatin core, 0.13 µm process) with internal L2 cache");
							break;
						default:		// *bored*
							strcat(m_cCPUName, "Intel Pentium III Tualatin core (unknown model, 0.13 µm process) with internal L2 cache");
							break;
					}
					break;
				default:		// *more bored*
		...
		case 15:		// Extended processor family
			...
			switch (m_CPUInfo.uiModel)
			{
				case 0:			// Model = 0:  Pentium 4 Willamette (A-Step) core
					...
					{
						strcpy(m_CPUInfo.strModel, "Intel Pentium 4 Willamette (A-Step)");
						strcat(m_cCPUName, "Intel Pentium 4 Willamette (A-Step)");
					}
					else							// else Xeon
					{
						strcpy(m_CPUInfo.strModel, "Intel Pentium 4 Willamette Xeon (A-Step)");
						strcat(m_cCPUName, "Intel Pentium 4 Willamette Xeon (A-Step)");
					}
					break;
				case 1:			// Model = 1:  Pentium 4 Willamette core
					if ((m_CPUInfo.uiBrandID) == 8)	// Brand id = 8:  P4 Willamette
					{
						strcpy(m_CPUInfo.strModel, "Intel Pentium 4 Willamette");
						strcat(m_cCPUName, "Intel Pentium 4 Willamette");
					}
					else							// else Xeon
					{
						strcpy(m_CPUInfo.strModel, "Intel Pentium 4 Willamette Xeon");
						strcat(m_cCPUName, "Intel Pentium 4 Willamette Xeon");
					}
					break;
				case 2:			// Model = 2:  Pentium 4 Northwood core
					if (((m_CPUInfo.uiBrandID) == 9) || ((m_CPUInfo.uiBrandID) == 0xA))		// P4 Willamette
					{
					...
					{
						strcpy(m_CPUInfo.strModel, "Intel Pentium 4 Northwood Xeon");
	...
	if (m_CPUInfo.MaxSupportedLevel >= 3)
	{
		...
		sprintf(m_CPUInfo.strProcessorSerial, "%04lX-%04lX-%04lX-%04lX-%04lX-%04lX", sig1 >> 16, sig1 & 0xFFFF, sig3 >> 16, sig3 & 0xFFFF, sig2 >> 16, sig2 & 0xFFFF);
	}
	else
	{
		...
		case 4:			// Family = 4:  486 (80486) or 5x85 (80486) processor family
			switch (m_CPUInfo.uiModel)
			{
				...
				case 7:			// Model = 7:  80486 write-back enhanced DX2
					strcpy(m_CPUInfo.strModel, "AMD 80486 write-back enhanced DX2");
				...
				case 9:			// Model = 9:  80486 write-back enhanced DX4
					strcpy(m_CPUInfo.strModel, "AMD 80486 write-back enhanced DX4");
				...
				case 0xF:		// Model = 0xF:  5x86 write-back enhanced (oh my god.....)
					...
					break;
				default:		// ...
					strcpy(m_CPUInfo.strModel, "Unknown AMD 80486 or 5x86 model");
		...
		case 5:			// Family = 5:  K5 / K6 processor family
			switch (m_CPUInfo.uiModel)
			{
				case 0:			// Model = 0:  K5 SSA 5 (Pentium Rating *ggg* 75, 90 and 100 Mhz)
					strcpy(m_CPUInfo.strModel, "AMD K5 SSA5 (PR75, PR90, PR100)");
					strcat(m_cCPUName, "AMD K5 SSA5 (PR75, PR90, PR100)");
					break;
				...
				case 0xD:		// Model = 0xD:  K6-2+ / K6-III+
					strcpy(m_CPUInfo.strModel, "AMD K6-2+ or K6-III+ (0.18 µm)");
		...
		case 6:			// Family = 6:  K7 processor family (AMDs first good processors)
			switch (m_CPUInfo.uiModel)
			{
				...
				case 6:			// Athlon MP / Mobile Athlon (Palomino core)
					strcpy(m_CPUInfo.strModel, "AMD Athlon MP/Mobile Athlon (Palomino)");
					strcat(m_cCPUName, "AMD Athlon MP/Mobile Athlon (Palomino core)");
					break;
