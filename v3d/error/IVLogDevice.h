...
protected:
	...
	virtual void	OnMessage(const std::string& Message, const eLogMode LogMode )=0;
	
	virtual void	OnProgressbarBegin()=0;
	virtual void	OnProgressbarUpdate( const vfloat32 fIndex)=0;
	virtual void	OnProgressbarEnd()=0;

	virtual void	OnStateAdd( const std::string& StateName, const std::string& StateText ) =0;
	virtual void	OnStateUpdate( const std::string& StateName, const std::string& StateText ) =0;
	virtual void	OnStateDelete( const std::string& StateName ) =0;

	virtual void	OnInfoText( const vuint Index, const std::string& Text ) =0;
